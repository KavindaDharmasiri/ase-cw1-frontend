  ...
  template: `
    <nav class="navbar fade-in" *ngIf="isLoggedIn">
      ...
      <div class="nav-menu" [class.mobile-open]="mobileMenuOpen">
        ...
        <a *ngIf="userRole === 'RETAILER'" routerLink="/retailer" routerLinkActive="active" class="nav-link" (click)="closeMobileMenu()">
          <svg class="icon" viewBox="0 0 24 24" fill="currentColor">
            <path d="M7 18c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zM1 2v2h2l3.6 7.59-1.35 2.45c-.16.28-.25.61-.25.96 0 1.1.9 2 2 2h12v-2H7.42c-.14 0-.25-.11-.25-.25l.03-.12L8.1 13h7.45c.75 0 1.41-.41 1.75-1.03L21.7 4H5.21l-.94-2H1zm16 16c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"/>
          </svg>
          Retailer
        </a>
        <a *ngIf="userRole === 'RDC_STAFF'" routerLink="/rdc-staff" routerLinkActive="active" class="nav-link" (click)="closeMobileMenu()">
          <svg class="icon" viewBox="0 0 24 24" fill="currentColor">
            <path d="M20 6h-2.18c.11-.31.18-.65.18-1a2.996 2.996 0 0 0-5.5-1.65l-.5.67-.5-.68C10.96 2.54 10.05 2 9 2 7.34 2 6 3.34 6 5c0 .35.07.69.18 1H4c-1.11 0-1.99.89-1.99 2L2 19c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2zm-5-2c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zM9 4c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1z"/>
          </svg>
          RDC Staff
        </a>
        <a *ngIf="userRole === 'LOGISTICS'" routerLink="/logistics" routerLinkActive="active" class="nav-link" (click)="closeMobileMenu()">
          <svg class="icon" viewBox="0 0 24 24" fill="currentColor">
            <path d="M20 8h-3V4H3c-1.1 0-2 .9-2 2v11h2c0 1.66 1.34 3 3 3s3-1.34 3-3h6c0 1.66 1.34 3 3 3s3-1.34 3-3h2v-5l-3-4zM6 18.5c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5zm13.5-9l1.96 2.5H17V9.5h2.5zm-1.5 9c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5z"/>
          </svg>
          Logistics
        </a>
        <a *ngIf="userRole === 'HEAD_OFFICE_MANAGER'" routerLink="/head-office" routerLinkActive="active" class="nav-link" (click)="closeMobileMenu()">
          <svg class="icon" viewBox="0 0 24 24" fill="currentColor">
        ...
        <!-- Common features -->
        <a *ngIf="userRole === 'RETAILER'" routerLink="/product-catalog" routerLinkActive="active" class="nav-link" (click)="closeMobileMenu()">
          <svg class="icon" viewBox="0 0 24 24" fill="currentColor">
        ...
        <a *ngIf="userRole === 'HEAD_OFFICE_MANAGER'" routerLink="/bulk-upload" routerLinkActive="active" class="nav-link" (click)="closeMobileMenu()">
          <svg class="icon" viewBox="0 0 24 24" fill="currentColor">
            <path d="M14,2H6A2,2 0 0,0 4,4V20A2,2 0 0,0 6,22H18A2,2 0 0,0 20,20V8L14,2M18,20H6V4H13V9H18V20Z"/>
          </svg>
          Bulk Upload
        ...
        <a *ngIf="userRole === 'RDC_STAFF' || userRole === 'HEAD_OFFICE_MANAGER' || userRole === 'LOGISTICS'"
           routerLink="/inventory" routerLinkActive="active" class="nav-link" (click)="closeMobileMenu()">
          <svg class="icon" viewBox="0 0 24 24" fill="currentColor">
            <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
          </svg>
          Inventory
        </a>
        <a *ngIf="userRole === 'HEAD_OFFICE_MANAGER'" routerLink="/admin" routerLinkActive="active" class="nav-link" (click)="closeMobileMenu()">
          <svg class="icon" viewBox="0 0 24 24" fill="currentColor">
        ...
        <a *ngIf="userRole === 'HEAD_OFFICE_MANAGER'" routerLink="/rdc-management" routerLinkActive="active" class="nav-link" (click)="closeMobileMenu()">
          <svg class="icon" viewBox="0 0 24 24" fill="currentColor">
            <path d="M12 7V3H2v18h20V7H12zM6 19H4v-2h2v2zm0-4H4v-2h2v2zm0-4H4V9h2v2zm0-4H4V5h2v2zm4 12H8v-2h2v2zm0-4H8v-2h2v2zm0-4H8V9h2v2zm0-4H8V5h2v2zm10 12h-8v-2h2v-2h-2v-2h2v-2h-2V9h8v10zm-2-8h-2v2h2v-2zm0 4h-2v2h2v-2z"/>
          </svg>
          RDC Management
        </a>
        <a *ngIf="userRole === 'LOGISTICS'" routerLink="/logistics/routes" routerLinkActive="active" class="nav-link" (click)="closeMobileMenu()">
          <svg class="icon" viewBox="0 0 24 24" fill="currentColor">
            <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
          </svg>
          Route Management
        ...
        <a *ngIf="userRole === 'HEAD_OFFICE_MANAGER'" routerLink="/suppliers" routerLinkActive="active" class="nav-link" (click)="closeMobileMenu()">
          <svg class="icon" viewBox="0 0 24 24" fill="currentColor">
            <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
          </svg>
          Suppliers
        </a>
        <a *ngIf="userRole === 'HEAD_OFFICE_MANAGER'" routerLink="/procurement" routerLinkActive="active" class="nav-link" (click)="closeMobileMenu()">
          <svg class="icon" viewBox="0 0 24 24" fill="currentColor">
            <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-5 14H7v-2h7v2zm3-4H7v-2h10v2zm0-4H7V7h10v2z"/>
          </svg>
          Procurement
        </a>
        <a *ngIf="userRole === 'HEAD_OFFICE_MANAGER'" routerLink="/vehicles" routerLinkActive="active" class="nav-link" (click)="closeMobileMenu()">
          <svg class="icon" viewBox="0 0 24 24" fill="currentColor">
            <path d="M18.92 6.01C18.72 5.42 18.16 5 17.5 5h-11c-.66 0-1.22.42-1.42 1.01L3 12v8c0 .55.45 1 1 1h1c.55 0 1-.45 1-1v-1h12v1c0 .55.45 1 1 1h1c.55 0 1-.45 1-1v-8l-2.08-5.99zM6.5 16c-.83 0-1.5-.67-1.5-1.5S5.67 13 6.5 13s1.5.67 1.5 1.5S7.33 16 6.5 16zm11 0c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5zM5 11l1.5-4.5h11L19 11H5z"/>
          </svg>
          Vehicles
        </a>
        <a *ngIf="userRole === 'RDC_STAFF'" routerLink="/goods-receipt" routerLinkActive="active" class="nav-link" (click)="closeMobileMenu()">
          <svg class="icon" viewBox="0 0 24 24" fill="currentColor">
            <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-8 12l-4-4 1.41-1.41L11 12.17l6.59-6.59L19 7l-8 8z"/>
          </svg>
          Goods Receipt
        ...
        <a *ngIf="userRole === 'RDC_STAFF'" routerLink="/driver-settlements" routerLinkActive="active" class="nav-link" (click)="closeMobileMenu()">
          <svg class="icon" viewBox="0 0 24 24" fill="currentColor">
            <path d="M11.8 10.9c-2.27-.59-3-1.2-3-2.15 0-1.09 1.01-1.85 2.7-1.85 1.78 0 2.44.85 2.5 2.1h2.21c-.07-1.72-1.12-3.3-3.21-3.81V3h-3v2.16c-1.94.42-3.5 1.68-3.5 3.61 0 2.31 1.91 3.46 4.7 4.13 2.5.6 3 1.48 3 2.41 0 .69-.49 1.79-2.7 1.79-2.06 0-2.87-.92-2.98-2.1h-2.2c.12 2.19 1.76 3.42 3.68 3.83V21h3v-2.15c1.95-.37 3.5-1.5 3.5-3.55 0-2.84-2.43-3.81-4.7-4.4z"/>
          </svg>
          Settlements
        </a>
        <a *ngIf="userRole === 'RETAILER'" routerLink="/cart" routerLinkActive="active" class="nav-link" (click)="closeMobileMenu()">
          <svg class="icon" viewBox="0 0 24 24" fill="currentColor">
        ...
        <a routerLink="/notifications" routerLinkActive="active" class="nav-link" (click)="closeMobileMenu()">
          <svg class="icon" viewBox="0 0 24 24" fill="currentColor">
